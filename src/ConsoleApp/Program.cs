...
double Volumen = Application.Figura261E05.Volumen(Area, alturaprisma);
...
Console.WriteLine($"El volumen de un Trapecio con area de base {Area}cm² y {alturaprisma}cm de altura es: {Volumen}cm³");
